...
describe('Day 00 - Advent of Code 2019', () => {
  describe('Part 1', () => {
    xdescribe('Provided test cases', () => {
      it.each([])('Should return %p when given input %p', (want, have) => {
    ...
    xdescribe('Puzzle answer', () => {
      it('Should return the correct answer when given the actual input', () => {
        expect(part1(readFileSync('2019/input/day00.txt', 'utf-8'))).toBe(
          undefined
        )
      })
    })
  ...
  describe('Part 2', () => {
    ...
    xdescribe('Puzzle answer', () => {
      it('Should return the correct answer when given the actual input', () => {
        expect(part2(readFileSync('2019/input/day00.txt', 'utf-8'))).toBe(
          undefined
        )
      })
    })
